...
at any OpenAI-compatible endpoint (a local model costs nothing), prove it with
`uv run python -m cafe.doctor`, and open a session with
`uv run marimo edit notebooks/s01_agent_loop_toy.py`. Course logic is Python
...
|---|---|---|---|---|---|
| 1 | [The agent loop](S01-agent-loop.html) | A client-side loop around a stateless API; append-verbatim and tool-pairing invariants | [s01_agent_loop_toy.py](../notebooks/s01_agent_loop_toy.py) | [s01_loop.md](../labs/s01_loop.md) | [▶](videos/S01-agent-loop.mp4) |
| 2 | [Golden sets & baselines](S02-golden-evals.html) | Evals as measurement instruments; scripted users, two-tier checkers, fixture invariant, naive baseline | [s02_scripted_user_eval_toy.py](../notebooks/s02_scripted_user_eval_toy.py) | [s02_evals.md](../labs/s02_evals.md) | [▶](videos/S02-golden-evals.mp4) |
| 3 | [Context engineering](S03-context-engineering.html) | Compaction, pinning, attention decay; watch a buried rule die across a compaction boundary | [s03_context_engineering_toy.py](../notebooks/s03_context_engineering_toy.py) | [s03_context.md](../labs/s03_context.md) | [▶](videos/S03-context-engineering.mp4) |
| 4 | [Structured generation](S04-structured-generation.html) | Schema as contract; validate-and-retry; valid ≠ correct | [s04_structured_generation_toy.py](../notebooks/s04_structured_generation_toy.py) | [s04_schema.md](../labs/s04_schema.md) | [▶](videos/S04-structured-generation.mp4) |
| 5 | [The consent gate](S05-consent-gate.html) | Plan-then-execute; approve/edit/reject; violation semantics; abort vs degrade | [s05_consent_gate_toy.py](../notebooks/s05_consent_gate_toy.py) | [s05_consent.md](../labs/s05_consent.md) | [▶](videos/S05-consent-gate.mp4) |
| 6 | [Layered detection](S06-layered-detection.html) | Keyword-floor + classifier pipeline; policy as data; the false-trigger counter | [s06_layered_detection_toy.py](../notebooks/s06_layered_detection_toy.py) | [s06_policy.md](../labs/s06_policy.md) | [▶](videos/S06-layered-detection.mp4) |
| 7 | [The repair loop](S07-repair-loop.html) | Bounded regeneration; the curated failure view; what context a retry gets | [s07_repair_loop_toy.py](../notebooks/s07_repair_loop_toy.py) | [s07_repair.md](../labs/s07_repair.md) | [▶](videos/S07-repair-loop.mp4) |
| 8 | [Observability & replay](S08-observability-replay.html) | Spans and traces; fail-soft telemetry; record/replay content-identical; hunt planted nondeterminism | [s08_observability_replay_toy.py](../notebooks/s08_observability_replay_toy.py) | [s08_replay.md](../labs/s08_replay.md) | [▶](videos/S08-observability-replay.mp4) |
| 9 | [Evidence reports](S09-evidence-reports.html) | Reports a depleted reader can trust; citation and coverage validators; the 30-second test | [s09_evidence_report_toy.py](../notebooks/s09_evidence_report_toy.py) | [s09_debrief.md](../labs/s09_debrief.md) | [▶](videos/S09-evidence-reports.mp4) |
| 10 | [Error analysis](S10-error-analysis.html) | Failure logs → taxonomy → new evals; open and axial coding on real traces | [s10_error_analysis_toy.py](../notebooks/s10_error_analysis_toy.py) | [s10_errors.md](../labs/s10_errors.md) | [▶](videos/S10-error-analysis.mp4) |
| 11 | [Budgets & routing](S11-budgets-routing.html) | Budgets as runtime invariants; routing as policy-as-data; the privacy boundary; latency math | [s11_budgets_routing_toy.py](../notebooks/s11_budgets_routing_toy.py) | [s11_budgets.md](../labs/s11_budgets.md) | [▶](videos/S11-budgets-routing.mp4) |
| 12 | [Judge calibration](S12-judge-calibration.html) | Seeded-defect games; label-before-you-see-the-judge; Cohen's κ; rates → policy | [s12_judge_calibration_toy.py](../notebooks/s12_judge_calibration_toy.py) | [s12_judge.md](../labs/s12_judge.md) | [▶](videos/S12-judge-calibration.mp4) |
