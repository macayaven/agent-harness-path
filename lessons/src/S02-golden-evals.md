...
**Hands-on:** [`notebooks/s02_scripted_user_eval_toy.py`](../notebooks/s02_scripted_user_eval_toy.py) — runs against **your** model.
**Video:** [Gemini Notebook overview](videos/S02-golden-evals.mp4) — generated with Google Gemini Notebook (formerly NotebookLM); recorded against an earlier cut of this path, so it still uses the previous toy domain. Preview or review, never a substitute for the notebook.
...
Open [`notebooks/s02_scripted_user_eval_toy.py`](../notebooks/s02_scripted_user_eval_toy.py).
...
uv run marimo edit notebooks/s02_scripted_user_eval_toy.py
```
...
a change helped. **[S03 — Context engineering](S03-context-engineering.html)**
