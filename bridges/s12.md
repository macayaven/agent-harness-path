...
Core: `lessons/S12-judge-calibration.html`,
`notebooks/s12_judge_calibration_toy.py`, `cafe/judge.py` (the seeded-defect
game, detection/false-positive rates, agreement math; Cohen’s κ is `None` when
undefined). Optional trivia lab: `labs/s12_judge.md`.
