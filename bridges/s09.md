...
Core: `lessons/S09-evidence-reports.html`,
`notebooks/s09_evidence_report_toy.py`, `cafe/report.py` (`write_report`, the
citation validators). Optional trivia lab: `labs/s09_debrief.md`,
...
uv run marimo edit notebooks/s09_evidence_report_toy.py
