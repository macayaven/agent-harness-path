...
Core: `lessons/S03-context-engineering.html`,
`notebooks/s03_context_engineering_toy.py`, `cafe/context.py` (`policy_summarize`,
`summarize_turns`, the compaction policies). Optional trivia lab:
`labs/s03_context.md`, `labs/trivia_host/engine.py` (`compact`, `run_engine`
...
uv run marimo edit notebooks/s03_context_engineering_toy.py
