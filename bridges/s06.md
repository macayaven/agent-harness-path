...
Core: `lessons/S06-layered-detection.html`,
`notebooks/s06_layered_detection_toy.py`, `cafe/detect.py` (`decide`, the
ordered screen pipeline). Optional trivia lab: `labs/s06_policy.md`,
