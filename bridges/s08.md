...
Core: `lessons/S08-observability-replay.html`,
`notebooks/s08_observability_replay_toy.py`, `cafe/trace.py` (spans, the JSONL
shift record, exact replay). Optional trivia lab: `labs/s08_replay.md`,
...
uv run marimo edit notebooks/s08_observability_replay_toy.py
