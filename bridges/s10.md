...
Core: `lessons/S10-error-analysis.html`,
`notebooks/s10_error_analysis_toy.py`, `cafe/taxonomy.py` (failure bucketing →
ranked taxonomy → new eval task). Optional trivia lab: `labs/s10_errors.md`,
