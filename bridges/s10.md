...
`lessons/S10-error-analysis.html`, `notebooks/s10_error_analysis_toy.ipynb`,
`labs/s10_errors.md`, `labs/evals/tasks.py` p07–p09, `labs/run.py` `S10_IDS`
(denominator **9**).

## The gap

The toy open-codes a handful of failures. The lab asks you to read **fixture**
transcripts from S02–S09 suite runs (not the S09 real round), group them, and
write `labs/work/failure-taxonomy.md` (gitignored) with ≥1 trace reference
per row.
