...
Core: `lessons/S07-repair-loop.html`,
`notebooks/s07_repair_loop_toy.py`, `cafe/repair.py` (bounded regeneration on a
bad ticket). Optional trivia lab: `labs/s07_repair.md`, repair
...
uv run marimo edit notebooks/s07_repair_loop_toy.py
