...
course archive and course issues in this repository. **v0.3.0 supersedes
v0.2.0:** the supported taking path is the clone in Cursor. CourseWeave remains
a separate application with its own version, artifacts and release. The v0.2.0
macOS bundle is historical.

v0.1.0 is a public tag without a GitHub Release. v0.2.0 remains the previous
course cut. Preparing this file does not create a tag or public asset.
