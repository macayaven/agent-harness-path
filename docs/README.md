...
a clone in Cursor ([companion guide](COMPANION.md)). CourseWeave remains an
optional application with its own repository, package version and release
process; it is not the supported learner product.
