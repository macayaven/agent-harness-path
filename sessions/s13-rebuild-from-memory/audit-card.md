...
2. Preserve a clean committed original and its banked suite result. A course clone has Git history for the course, not for your café-host edits. If using your completed café lab, first copy your completed work into a separate nonsynced local project, version it there and verify its suite. Keep the original student folder intact.
...
For your completed café host, bank and later rerun
